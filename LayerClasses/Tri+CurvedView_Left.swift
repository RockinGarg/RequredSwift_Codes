...
//MARK:- Tri_CurvedView_Left
/**
 This class is used to add a curved view with Left sided arrow
 */
class Tri_CurvedView_Left: UIView
{    
    /// Background color
    ...
    init(frame:CGRect,Base_Color:UIColor) {
        ...
        /// Set Arrow Height
        self.arrowHeight = frame.size.height*0.07
    }    
    ...
    override func draw(_ rect: CGRect) {
        ...
        boundryPath.move(to: CGPoint(x: minx+startingDistance!+(arrowWidth!/2), y: miny))
        boundryPath.addLine(to: CGPoint(x: minx+startingDistance!, y: miny+arrowHeight!))
        /// First Curve
        boundryPath.addQuadCurve(to: CGPoint(x: minx, y: miny+startingDistance!+arrowHeight!), control: CGPoint(x: minx, y: miny+arrowHeight!))
        ...
        boundryPath.addLine(to: CGPoint(x: maxx, y: miny+arrowHeight!+startingDistance!))
        
        /// Last Curve
        boundryPath.addQuadCurve(to: CGPoint(x: maxx-startingDistance!, y: miny+arrowHeight!), control: CGPoint(x: maxx, y: miny+arrowHeight!))
        boundryPath.addLine(to: CGPoint(x: minx+startingDistance!+arrowWidth!, y: miny+arrowHeight!))
